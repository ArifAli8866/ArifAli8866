...
<div style="
    ...
    width: 200px;
    height: 200px;
    background: radial-gradient(circle, rgba(127, 63, 191, 0.1) 0%, transparent 70%);
    border-radius: 50%;">
</div>
...
<div style="
  ...
  -
    ...
    <div style="
        ...
        font-size: 3em;
        box-shadow: 0 10px 30px rgba(127, 63, 191, 0.4);
    ...
    <div>
        ...
        <p style="
            ...
            color: #FFD700;
            font-size: 1em;">
            🎓 FAST NUCEIS | 📍 Islamabad, Pakistan
        </p>
    </div>
</div>
...
-
    ...
    <div style="
        ...
        <p style="
            ...
            margin: 0;
            font-size: 1.05em;">
            Hello! I'm a passionate Computer Science student at FAST NUCEIS, 
            deeply fascinated by the art of creating impactful software solutions. 
            My journey in tech began with curiosity and has evolved into a 
            dedicated pursuit of excellence in software engineering.
        </p>
        ...
        <div style="
            ...
            border-radius: 10px;
            border-left: 3px solid #7F3FBF;">
            <p style="
                margin: 0;
                color: #FFD700;
                font-style: italic;
                font-size: 0.95em;">
                "I believe in writing clean, efficient code that solves real problems 
    ...
    <div style="
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
            <div style="
                ...
                <div>
                    <div style="color: #fff; font-weight: 600;">C++ & Data Structures</div>
                    <div style="color: #FFD700; font-size: 0.9em;">Mastering algorithms & system design</div>
                </div>
            </div>
            ...
            <div style="
                ...
                <div style="font-size: 1.5em;">🌐</div>
                <div>
                    <div style="color: #fff; font-weight: 600;">Full-Stack Development</div>
                    <div style="color: #FFD700; font-size: 0.9em;">React, Node.js & modern web tech</div>
                </div>
            </div>
            ...
            <div style="
                ...
                <div style="font-size: 1.5em;">🚀</div>
                <div>
                    <div style="color: #fff; font-weight: 600;">Apache Projects</div>
                    <div style="color: #FFD700; font-size: 0.9em;">Contributing to open-source</div>
                </div>
            </div>
        </div>
    </div>
...
<div style="
    ...
    <div style="
        ...
        <div style="
            ...
            <div style="color: #fff; font-weight: 600;">Internships</div>
            <div style="color: #FFD700; font-size: 0.8em; margin-top: 5px;">Completed</div>
        </div>
        ...
        <div style="
            ...
            <div style="color: #fff; font-weight: 600;">Certifications</div>
            <div style="color: #FFD700; font-size: 0.8em; margin-top: 5px;">Earned</div>
        </div>
        ...
        <div style="
            ...
            <div style="color: #fff; font-weight: 600;">Projects</div>
            <div style="color: #FFD700; font-size: 0.8em; margin-top: 5px;">Built</div>
        </div>
        ...
        <div style="
            ...
            <div style="color: #fff; font-weight: 600;">WPM</div>
            <div style="color: #FFD700; font-size: 0.8em; margin-top: 5px;">Typing Speed</div>
        </div>
    </div>
</div>
